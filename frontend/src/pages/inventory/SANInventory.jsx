...
const FIELDS = [
  ...
  { key: 'ports_total', label: 'Tổng port', type: 'number', width: 70 },
  { key: 'ports_used', label: 'Đã dùng', type: 'number', width: 65 },
  { key: 'ports_unused', label: 'Trống', type: 'number', width: 60 },
  { key: 'ports_licensed', label: 'Licensed', type: 'number', width: 70 },
